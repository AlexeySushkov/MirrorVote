...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'nav.new': 'Новая',
    'nav.logout': 'Выйти',
    'session.status.uploading': 'Загрузка',
    'session.status.normalizing': 'Обработка',
    'session.status.ready': 'Готово',
    'session.status.analyzed': 'Проанализировано',
  ...
  en: {
    ...
    'session.status.normalizing': 'Processing',
    'session.status.ready': 'Ready',
    'session.status.analyzed': 'Analyzed',
