...
- **Кнопка «Удалить выбранное»** — перемещена из шапки страницы в нижнюю строку под списком сессий; появляется только при наличии выбранных карточек, занимает всю ширину
