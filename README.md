...
- **Диалог ссылки для голосования** — после генерации ссылки открывается диалог с тремя кнопками: «Скопировать ссылку» (копирует в буфер, закрывает диалог), «Открыть в новом окне» (открывает вкладку, закрывает диалог), «Отмена». Работает в карточке сессии (Sessions) и на странице Compare
